...
public class mail {
    ...
    public static void SendMail(String UserMail) throws Exception {
        ...
        ts.connect("smtp.qq.com","1059954375", "idxevwekwhrnbfji");//后面的字符是授权码
        // 创建邮件
        Message message = createSimpleMail(session,UserMail);
        // 发送邮件
     ...
     */
    public static MimeMessage createSimpleMail(Session session,String UserMail)throws Exception {

        String VerificationCode="你的Chat验证码为：";
